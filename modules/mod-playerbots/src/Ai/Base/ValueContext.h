...
public:
    ValueContext()
    {
        ...
        creators["ab committed node"] = &ValueContext::ab_committed_node;
...
private:
    ...
    static UntypedValue* ab_committed_node(PlayerbotAI* botAI) { return new ABCommittedNodeValue(botAI); }
